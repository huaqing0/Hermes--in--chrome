...
const ZH: Dict = {
  ...
  header_theme_to_dystopia: '切换到 Odyssey 主题',
  header_history: '历史对话',
  header_export_md: '导出对话为 Markdown',
  header_new_chat: '新对话',
  header_lang_toggle: '切换语言 / Switch language',
  header_settings_short: '设置',
  header_theme_short: '主题',
  header_lang_short: '语言',
  header_history_short: '历史',
  header_export_short: '导出',
  header_new_chat_short: '新对话',
  status_online: 'ONLINE',
  status_offline: 'OFFLINE',
  system_op: 'AGENT VOYAGE · {n} TOOLS',
  tab_tag: 'BROWSER TAB',
  ...
  settings_vision_status: '视觉能力',
  settings_vision_true: 'Vision',
  settings_vision_false: 'Text only',
  settings_vision_unknown: 'Unknown',
  settings_custom_vision: '此 Custom / Local 模型支持视觉',
  settings_vision_note: '视觉检查会把页面截图发送给当前视觉模型；无视觉主模型会走 Hermes auxiliary.vision。',
  ...
  settings_no_status: '未查询，点测试模型、测试视觉或登录。',
  settings_refresh: '刷新',
  settings_test_conn: '测试连接',
  settings_test_model: '测试模型',
  settings_test_vision: '测试视觉',
  ...
  mode_auto_short: '自动',
  mode_approval: '逐步审批（Ask before tools）',
  mode_approval_short: '审批',
  mode_plan: '计划模式（只读调研）',
  mode_plan_short: '计划',
...
const EN: Dict = {
  ...
  header_theme_to_dystopia: 'Switch to Odyssey theme',
  ...
  header_settings_short: 'Settings',
  header_theme_short: 'Theme',
  header_lang_short: 'Language',
  header_history_short: 'History',
  header_export_short: 'Export',
  header_new_chat_short: 'New chat',
  status_online: 'ONLINE',
  status_offline: 'OFFLINE',
  system_op: 'AGENT VOYAGE · {n} TOOLS',
  tab_tag: 'BROWSER TAB',
  ...
  settings_vision_status: 'Vision capability',
  settings_vision_true: 'Vision',
  settings_vision_false: 'Text only',
  settings_vision_unknown: 'Unknown',
  settings_custom_vision: 'This Custom / Local model supports vision',
  settings_vision_note: 'Visual inspection sends screenshots to the active vision provider; text-only main models use Hermes auxiliary.vision.',
  settings_api_key: 'API Key',
  ...
  settings_no_status: 'Not queried yet — click Test model, Test vision, or Log in.',
  settings_refresh: 'Refresh',
  settings_test_conn: 'Test connection',
  settings_test_model: 'Test model',
  settings_test_vision: 'Test vision',
  ...
  mode_approval: 'Ask before tools',
  mode_approval_short: 'Review',
