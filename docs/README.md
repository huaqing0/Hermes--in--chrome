...
1. **Theme comparison (PNG)** — Odyssey vs Synthwave side by side.
2. **Feature GIF (<= 5 MB)** — 30-60 seconds: open sidepanel, type a research prompt, watch the agent open a tab, read the a11y tree, and stream the reply.
3. **Demo video** — 1-3 minute YouTube / Bilibili upload, linked from the README.
...
- Crop tightly; empty browser chrome around the sidepanel hurts engagement.
